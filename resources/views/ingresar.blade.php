...
<form name="form1" method="post" action="">
  ...
  <p>&nbsp;</p>
  <table width="1542" height="480" border="1" align="left" bgcolor="#CCCCCC">
    <tr>
      <td width="113"><table width="113" height="176" border="1" bgcolor="#"><a href="{{url('Index')}}"><img src="i.JPG" width="27" height="27"></a>
        <tr>
          <td bgcolor="#FFFFFF" class="letra">Dar de alta</td>
        </tr>
        <tr>
